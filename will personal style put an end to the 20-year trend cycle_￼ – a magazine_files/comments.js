// comments box on story pages
	jQuery(document).ready(function($) {
		...
		// on load, check the cookie to see if this post has been like. If so, flag it with a data attibute so that other actions can be based on this
		...
		$('body').on('click', '.like-side-icon', function(event) {
		...
		*/
		...
		$('body').on('click', '.sno-comment-bar,.sno-comments,.comment-side-icon,a#commentslink', function() {
			$('#sno-comments-side').css('transform', 'none');
